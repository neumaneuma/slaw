...
# did this part manually since this fails with │ Error: updating GuardDuty Organization Configuration (eecb77edbcc1ab393f023fedea930c06): operation error GuardDuty: UpdateOrganizationConfiguration, https response error StatusCode: 400, RequestID: bd75f2bb-dbfb-4d76-a9d0-4c98a6ff97fc, BadRequestException: The request is rejected because an invalid or out-of-range value is specified as an input parameter.
